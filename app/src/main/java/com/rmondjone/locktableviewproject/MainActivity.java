...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            mRowDatas.add("ID" + i);
            for (int j = 0; j < 10; j++) {
                mRowDatas.add("" + (int)( Math.random()*30-i+j));
            }
        ...
        mLockTableView.setLockFristColumn(true) //是否锁定第一列
                ...
                .setMaxColumnWidth(1000) //列最大宽度
                .setMinColumnWidth(60) //列最小宽度
         //       .setColumnWidth(1,30) //设置指定列文本宽度
           //     .setColumnWidth(2,20)
                .setMinRowHeight(1)//行最小高度
        //        .setMaxRowHeight(60)//行最大高度
                .setTextViewSize(14) //单元格字体大小
                .setFristRowBackGroudColor(R.color.colorPrimary)//表头背景色
                .setTableHeadTextColor(R.color.white)//表头字体颜色
                .setTableContentTextColor(R.color.border_color)//单元格字体颜色
                .setCellPadding(1)//设置单元格内边距(dp)
...
*//*  *//*                                  for (int i = 0; i < 10; i++) {
                ...
                .setOnItemSeletor(R.color.colorPrimaryDark)//设置Item被选中颜色
                .show(); //显示表格,此方法必须调用
